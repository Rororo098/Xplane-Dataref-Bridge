...
This file provides complete working examples for both Arduino and PC sides 
of the communication protocol.
"""

# ARDUINO SIDE EXAMPLE (.ino file content)
ARDUINO_EXAMPLE = '''
// Arduino Message Functions Example
// Place this code in your Arduino .ino file
